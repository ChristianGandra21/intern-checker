...
export async function GET(request: NextRequest) {
  ...
  const filters: JobFilters = {
    ...
    deadline: ["open", "7d", "30d"].includes(params.get("deadline") || "") ? params.get("deadline") as JobFilters["deadline"] : undefined,
    salary: params.get("salary") === "informed" ? "informed" : undefined,
    skill: params.get("skill") ?? undefined,
    company: params.get("company") ?? undefined,
    novelty: ["new", "updated"].includes(params.get("novelty") || "") ? params.get("novelty") as JobFilters["novelty"] : undefined,
