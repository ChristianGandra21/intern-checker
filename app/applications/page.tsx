...
export default async function ApplicationsPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return <main id="conteudo" className="shell pb-20 pt-8">
    ...
    <ApplicationList applications={applications} now={now} values={{ q: valueOf(raw.q), applicationState: valueOf(raw.application_state), timing: valueOf(raw.timing), dateFrom: valueOf(raw.date_from), dateTo: valueOf(raw.date_to) }} />
  </main>;
}
