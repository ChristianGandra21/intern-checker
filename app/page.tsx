    ...
    <main id="conteudo" className="shell pb-16 pt-6">
      ...
      <section className="enter enter-delay-1 mt-8" aria-labelledby="oportunidades-title">
        <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="flex items-center gap-3"><span className="mono text-sm">{data.total} resultados</span><Link prefetch={false} className="button-light" href="/api/export/csv">Baixar CSV</Link></div>
        </div>
        ...
        <div className="mt-4"><JobList jobs={data.jobs} isDemo={data.isDemo} authenticated={data.authenticated} savedJobIds={data.savedJobIds} /></div>
