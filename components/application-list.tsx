import { ArrowRight, CalendarClock, CalendarDays, CircleAlert, Plus, Search } from "lucide-react";
...
export function ApplicationList({ applications, values, now }: { applications: TrackedApplication[]; values: { q?: string; applicationState?: string; timing?: string; dateFrom?: string; dateTo?: string }; now: number }) {
  ...
  return <>
    <form className="surface mb-5 grid gap-3 p-4 md:grid-cols-2 xl:grid-cols-[minmax(240px,1fr)_190px_170px_170px_170px_auto]">
